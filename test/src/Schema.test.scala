...
class SchemaTests extends FunSuite:
  ...
  test("drop"):
    ...
    val expected = List(
      "REVOKE USAGE ON DATABASE EDW_DEV FROM DATABASE ROLE EDW_DEV.CUSTOMER_R",
      "REVOKE USAGE ON SCHEMA EDW_DEV.CUSTOMER FROM DATABASE ROLE EDW_DEV.CUSTOMER_R",
      "REVOKE SELECT ON FUTURE TABLES IN SCHEMA EDW_DEV.CUSTOMER FROM DATABASE ROLE EDW_DEV.CUSTOMER_R",
      "REVOKE SELECT ON ALL TABLES IN SCHEMA EDW_DEV.CUSTOMER FROM DATABASE ROLE EDW_DEV.CUSTOMER_R",
      "DROP DATABASE ROLE IF EXISTS EDW_DEV.CUSTOMER_R",
      "REVOKE DATABASE ROLE EDW_DEV.CUSTOMER_R FROM DATABASE ROLE EDW_DEV.CUSTOMER_RW",
      "REVOKE INSERT, UPDATE, TRUNCATE, DELETE ON FUTURE TABLES IN SCHEMA EDW_DEV.CUSTOMER FROM DATABASE ROLE EDW_DEV.CUSTOMER_RW",
      "REVOKE INSERT, UPDATE, TRUNCATE, DELETE ON ALL TABLES IN SCHEMA EDW_DEV.CUSTOMER FROM DATABASE ROLE EDW_DEV.CUSTOMER_RW",
